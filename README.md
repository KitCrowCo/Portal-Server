...
AGPLv3. This matters specifically because this is self-hostable server software — AGPL closes the loophole in GPL where someone could run a modified version as a network service without ever distributing the modified source. If you run a modified version of this and let others use it over a network, they're entitled to the source of your modifications.
...
This is a personal project, actively maintained by one person, and not currently seeking contributors or co-maintainers. You're free to fork it, modify it, and run your own version under the terms of the AGPLv3 license — that's the point of it being open source. Issues reporting genuine bugs are welcome; unsolicited large feature PRs are unlikely to be merged, since the project has a specific architectural direction that isn't a democratic process.